...
# Build the tool
gcc -Wall -Wextra -g $USB_CFLAGS -o hailo_sw_update hailo_sw_update.c $USB_LIBS

if [ $? -eq 0 ]; then
    echo "✓ Build successful: hailo_sw_update"
    echo "Usage: ./hailo_sw_update [-v] <swu_image_file>"
    echo ""
