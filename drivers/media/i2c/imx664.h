...
#define IMX664_CID_CUSTOM_RHS1 (IMX664_CID_BASE + 13)
#define IMX664_CID_WDR_PRIMING (IMX664_CID_BASE + 14)
#define IMX664_CID_CUSTOM_RHS1_PRIMING (IMX664_CID_BASE + 15)
#define IMX664_CID_HCG_LEF  (IMX664_CID_BASE + 16)
#define IMX664_CID_HCG_SEF1 (IMX664_CID_BASE + 17)
#define IMX664_CID_HCG_SEF2 (IMX664_CID_BASE + 18)
