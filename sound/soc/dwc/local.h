...
enum i2s_config_id {
	CONFIG_ID_DW_I2S__SNPS = 0x1,
	CONFIG_ID_DW_I2S__HAILO_PCM_PROCESSING_ONLY,
	CONFIG_ID_DW_I2S__HAILO_PCM_PROCESSING_AND_SCU_DMA,
	CONFIG_ID_DW_I2S__HAILO_SCU_DMA_ONLY,
};
