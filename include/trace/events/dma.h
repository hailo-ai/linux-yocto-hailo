...
/*
 * Backported from upstream Linux v6.13/v6.18 DMA mapping tracepoints.
 *
 * Upstream commits:
 *   038eb433dc14 dma-mapping: add tracing for dma-mapping API calls
 *   bfc4a245a794 dma-mapping: fix DMA API tracing for chained scatterlists
 *   78b2770c935f dma-mapping: fix tracing dma_alloc/free with vmalloc'd memory
 *   5af5fc895fb9 dma-mapping: use macros to define events in a class
 *   3afff779a725 dma-mapping: trace dma_alloc/free direction
 *   c4484ab86ee0 dma-mapping: use trace_dma_alloc for dma_alloc*
 *   68b6dbf1f441 dma-mapping: trace more error paths
 *   d5bbfbad58ec dma-mapping: fix swapped dir/flags arguments
 *   16abbabc004b dma-mapping: fix direction in dma_alloc direction traces
 */
#undef TRACE_SYSTEM
